...
import org.openapis.openapi.models.components.FeedResponseDto;
...
public class SubscribersV1ControllerGetNotificationsFeed {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerGetNotificationsFeedRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetNotificationsFeedResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetNotificationsFeedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetNotificationsFeedResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetNotificationsFeedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetNotificationsFeedResponse res = resBuilder.build();
