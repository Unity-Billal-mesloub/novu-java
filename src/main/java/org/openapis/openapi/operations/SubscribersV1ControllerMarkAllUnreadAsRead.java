...
public class SubscribersV1ControllerMarkAllUnreadAsRead {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerMarkAllUnreadAsReadRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkAllUnreadAsReadResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkAllUnreadAsReadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkAllUnreadAsReadResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkAllUnreadAsReadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkAllUnreadAsReadResponse res = resBuilder.build();
