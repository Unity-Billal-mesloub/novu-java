...
import org.openapis.openapi.models.components.MessageResponseDto;
...
public class SubscribersV1ControllerMarkMessagesAs {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerMarkMessagesAsRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkMessagesAsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkMessagesAsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkMessagesAsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkMessagesAsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkMessagesAsResponse res = resBuilder.build();
