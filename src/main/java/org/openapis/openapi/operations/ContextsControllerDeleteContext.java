...
public class ContextsControllerDeleteContext {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ContextsControllerDeleteContextRequest, org.openapis.openapi.models.operations.async.ContextsControllerDeleteContextResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ContextsControllerDeleteContextResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ContextsControllerDeleteContextResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ContextsControllerDeleteContextResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.ContextsControllerDeleteContextResponse res = resBuilder.build();
