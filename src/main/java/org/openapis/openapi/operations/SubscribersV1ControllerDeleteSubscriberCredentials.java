...
public class SubscribersV1ControllerDeleteSubscriberCredentials {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerDeleteSubscriberCredentialsRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerDeleteSubscriberCredentialsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerDeleteSubscriberCredentialsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerDeleteSubscriberCredentialsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerDeleteSubscriberCredentialsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerDeleteSubscriberCredentialsResponse res = resBuilder.build();
