...
import org.openapis.openapi.models.components.EnvironmentResponseDto;
...
public class EnvironmentsControllerV1UpdateMyEnvironment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnvironmentsControllerV1UpdateMyEnvironmentRequest, org.openapis.openapi.models.operations.async.EnvironmentsControllerV1UpdateMyEnvironmentResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.EnvironmentsControllerV1UpdateMyEnvironmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1UpdateMyEnvironmentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.EnvironmentsControllerV1UpdateMyEnvironmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1UpdateMyEnvironmentResponse res = resBuilder.build();
