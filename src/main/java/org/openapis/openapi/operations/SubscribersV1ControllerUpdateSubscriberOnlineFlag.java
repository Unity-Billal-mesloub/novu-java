...
import org.openapis.openapi.models.components.SubscriberResponseDto;
...
public class SubscribersV1ControllerUpdateSubscriberOnlineFlag {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerUpdateSubscriberOnlineFlagRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberOnlineFlagResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberOnlineFlagResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberOnlineFlagResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberOnlineFlagResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberOnlineFlagResponse res = resBuilder.build();
