...
public class EnvironmentsControllerV1DeleteEnvironment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnvironmentsControllerV1DeleteEnvironmentRequest, org.openapis.openapi.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse res = resBuilder.build();
