...
public class SubscribersV1ControllerUpdateSubscriberChannel {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerUpdateSubscriberChannelRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberChannelResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberChannelResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerUpdateSubscriberChannelResponse res = resBuilder.build();
