...
public class SubscribersV1ControllerModifySubscriberChannel {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerModifySubscriberChannelRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerModifySubscriberChannelResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerModifySubscriberChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerModifySubscriberChannelResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerModifySubscriberChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerModifySubscriberChannelResponse res = resBuilder.build();
