...
public class EnvironmentsControllerV1ListMyEnvironments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnvironmentsControllerV1ListMyEnvironmentsRequest, org.openapis.openapi.models.operations.async.EnvironmentsControllerV1ListMyEnvironmentsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.EnvironmentsControllerV1ListMyEnvironmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1ListMyEnvironmentsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.EnvironmentsControllerV1ListMyEnvironmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1ListMyEnvironmentsResponse res = resBuilder.build();
