...
import org.openapis.openapi.models.components.ListChannelEndpointsResponseDto;
...
public class ChannelEndpointsControllerListChannelEndpoints {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ChannelEndpointsControllerListChannelEndpointsRequest, org.openapis.openapi.models.operations.async.ChannelEndpointsControllerListChannelEndpointsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ChannelEndpointsControllerListChannelEndpointsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ChannelEndpointsControllerListChannelEndpointsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ChannelEndpointsControllerListChannelEndpointsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.ChannelEndpointsControllerListChannelEndpointsResponse res = resBuilder.build();
