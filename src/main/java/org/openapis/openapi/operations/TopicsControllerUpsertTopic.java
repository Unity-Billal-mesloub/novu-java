...
import org.openapis.openapi.models.components.TopicResponseDto;
import org.openapis.openapi.models.errors.APIException;
import org.openapis.openapi.models.errors.ErrorDto;
import org.openapis.openapi.models.errors.TopicResponseDtoException;
...
public class TopicsControllerUpsertTopic {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TopicsControllerUpsertTopicRequest, org.openapis.openapi.models.operations.async.TopicsControllerUpsertTopicResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.TopicsControllerUpsertTopicResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.TopicsControllerUpsertTopicResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.TopicsControllerUpsertTopicResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.TopicsControllerUpsertTopicResponse res = resBuilder.build();
