...
import org.openapis.openapi.models.components.LayoutResponseDto;
...
public class LayoutsControllerDuplicate {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LayoutsControllerDuplicateRequest, org.openapis.openapi.models.operations.async.LayoutsControllerDuplicateResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.LayoutsControllerDuplicateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.LayoutsControllerDuplicateResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.LayoutsControllerDuplicateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.LayoutsControllerDuplicateResponse res = resBuilder.build();
