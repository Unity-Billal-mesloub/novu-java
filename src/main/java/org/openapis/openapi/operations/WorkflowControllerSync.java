...
public class WorkflowControllerSync {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WorkflowControllerSyncRequest, org.openapis.openapi.models.operations.async.WorkflowControllerSyncResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.WorkflowControllerSyncResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.WorkflowControllerSyncResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.WorkflowControllerSyncResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.WorkflowControllerSyncResponse res = resBuilder.build();
