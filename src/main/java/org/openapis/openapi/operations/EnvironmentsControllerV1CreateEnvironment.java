...
public class EnvironmentsControllerV1CreateEnvironment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnvironmentsControllerV1CreateEnvironmentRequest, org.openapis.openapi.models.operations.async.EnvironmentsControllerV1CreateEnvironmentResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.EnvironmentsControllerV1CreateEnvironmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1CreateEnvironmentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.EnvironmentsControllerV1CreateEnvironmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.EnvironmentsControllerV1CreateEnvironmentResponse res = resBuilder.build();
