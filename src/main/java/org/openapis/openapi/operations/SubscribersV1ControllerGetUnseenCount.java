...
import org.openapis.openapi.models.components.UnseenCountResponse;
...
public class SubscribersV1ControllerGetUnseenCount {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerGetUnseenCountRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetUnseenCountResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetUnseenCountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetUnseenCountResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetUnseenCountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerGetUnseenCountResponse res = resBuilder.build();
