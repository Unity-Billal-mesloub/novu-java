...
public class SubscribersV1ControllerMarkActionAsSeen {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersV1ControllerMarkActionAsSeenRequest, org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkActionAsSeenResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkActionAsSeenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkActionAsSeenResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkActionAsSeenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubscribersV1ControllerMarkActionAsSeenResponse res = resBuilder.build();
