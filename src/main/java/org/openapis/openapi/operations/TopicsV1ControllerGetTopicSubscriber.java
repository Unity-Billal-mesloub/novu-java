...
import org.openapis.openapi.models.components.TopicSubscriberDto;
...
public class TopicsV1ControllerGetTopicSubscriber {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TopicsV1ControllerGetTopicSubscriberRequest, org.openapis.openapi.models.operations.async.TopicsV1ControllerGetTopicSubscriberResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.TopicsV1ControllerGetTopicSubscriberResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.TopicsV1ControllerGetTopicSubscriberResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.TopicsV1ControllerGetTopicSubscriberResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.TopicsV1ControllerGetTopicSubscriberResponse res = resBuilder.build();
